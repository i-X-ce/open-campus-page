...
const HeloSection = () => {
  return (
    <motion.section className={styles.section} id="hero-section"
      ...
      <div className={styles.container}>
        <div className={`${styles.textContainer} big-s`}>
          <div className={styles.lineWrapper1}>
            <motion.div className={styles.leftLine}
              initial={{ width: "50vw" }}
              variants={{
                sectionInView: { width: "100%", }
              }}
              transition={{ duration: 0.7, delay: kEY_FRAME.line, ease: "circOut" }}
            />
          </div>
          <div className={styles.lineWrapper2}>
            <motion.div className={styles.leftLine2}
              initial={{ height: "70vh" }}
              variants={{
                sectionInView: { height: "100%", }
              }}
              transition={{ duration: 0.6, delay: 0.5 + kEY_FRAME.line, ease: "circOut" }}
            />
          </div>
          <div>
            <motion.p
            ...
            >
              2025 <motion.div className={styles.day}>8/12-15
                <motion.div className={styles.dayBack}
                  initial={{ width: "100%" }}
                  variants={{ sectionInView: { width: "0%" } }}
                  transition={{ duration: 1, delay: 1 + kEY_FRAME.text, ease: "circOut" }}
                />
              </motion.div>
            </motion.div>
          </div>
